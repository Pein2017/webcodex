...
- [x] 1.1 Add exact guarded Skill and Plugin describe follow-ups at startup; verify executable calls, changed revision rejection, scope exclusion and existing hard output budgets with focused tests.

## 2. Recovery package

- [x] 2.1 Emit complete explicit handoff suggestions; verify missing ACK recovery and continued rejection of partial, mismatched or racing baselines with focused RED/GREEN checks.
