...
- [x] 1.1 Assess the last Web feedback against current source and live MCP discovery; record accepted, existing and deferred items in design.md.
- [x] 1.2 Validate the proposal/spec/design/tasks with strict OpenSpec validation before implementation.
...
- [ ] 3.1 Commit scoped changes, merge current upstream main, resolve routine conflicts and verify affected tests, formatting, OpenSpec and Git hygiene.
- [ ] 3.2 Build from clean source and pass the disposable Server/Runner smoke and existing optional-plugin checks; preserve an acceptance receipt.
